...
class Submit(Handler):
    def get(self):
        ...
        if not user:
            warning = "Your email account is not registered for access to this application. If you are a %(school)s staff member, you can register for access using the instructions provided by your school.  Contact your computer contact teacher if you need more information."
